...
const modelInsertRincianAnggaran = async(Uraian, Vol, Harga_Awal, Jumlah, Keterangan)=>{
    try {
        const result = await query(`
                                INSERT INTO master_rincian_anggaran (Uraian, Vol, Harga_Awal, Jumlah, Keterangan) 
                                VALUES (?, ?, ?, ?, ?)`, [Uraian, Vol, Harga_Awal, Jumlah, Keterangan]);
