...
import { DeleteDress, GetDressAll, insertDress, UpdateDress } from '../controller/dress.controllers.js'
import upload from '../middleware/multerconfig.middleware.js'


const router = express.Router()

router.get('/api/dress',authenticateToken, adminRole, GetDressAll)
router.get('/api/dress/:id',authenticateToken, adminRole, GetDressAll)
