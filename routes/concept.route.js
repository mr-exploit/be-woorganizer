...
import { GetConcept, getConceptEmailForm, getConceptIdForm, insertConcept } from '../controller/concept.controllers.js'
...
router.get("/api/concept/:id", authenticateToken,  
